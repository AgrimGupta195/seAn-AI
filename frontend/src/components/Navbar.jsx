    ...
    <div className="bg-[#050d1a]/85 border-b border-slate-800 fixed inset-x-0 top-0 px-4 md:px-6 py-3 backdrop-blur-xl shadow-lg z-50">
      <div className="flex justify-between items-center max-w-7xl mx-auto">
        ...
        <div className="hidden md:flex items-center gap-3 lg:gap-4">
          <Link to="/">
            <button className={`flex items-center gap-2 px-4 py-2 font-semibold rounded-lg transition-all text-sm ${
              isActive('/') 
                ? 'bg-gradient-to-r from-indigo-500 to-purple-500 text-white shadow-lg shadow-indigo-900/50' 
        ...
        <div className="md:hidden mt-4 pb-4 border-t border-gray-800 pt-4">
          <div className="flex flex-col gap-2">
            <Link to="/" onClick={() => setIsMobileMenuOpen(false)}>
              <button className={`w-full flex items-center gap-2 px-4 py-3 font-semibold rounded-lg transition-all ${
                isActive('/') 
                  ? 'bg-gradient-to-r from-indigo-500 to-purple-500 text-white shadow-lg shadow-indigo-900/50' 
